...
// Obtener los proyectos para el select
try {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($nombre) && !empty($descripcion) && !empty($fecha_inicio) && !empty($fecha_fin) && !empty($estado) && !empty($proyecto_id)) {
        // Insertar en la base de datos
        try {
            $sql = "INSERT INTO tareas (nombre, descripcion, fecha_inicio, fecha_fin, estado, proyecto_id, imagen) 
                    VALUES (:nombre, :descripcion, :fecha_inicio, :fecha_fin, :estado, :proyecto_id, :imagen)";
