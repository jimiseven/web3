                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <form action="registrar_posicion.php" method="post">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nombrePosicion" required>
                                </div>

                                <div class="mb-3">
                                    <label for="descripcion" class="form-label">Descripción de la Posición:</label>
                                    <textarea name="descripcion" class="form-control" rows="4" required></textarea>
                                </div>

                                <button type="submit" class="btn btn-primary">Registrar Posición</button>
                            </form>
